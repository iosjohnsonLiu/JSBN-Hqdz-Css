...
module.exports = function (grunt) {
  ...
  var getLessVarsData = function () {
    var filePath = path.join(__dirname, 'less/bootstrap/variables.less');
  ...
  grunt.registerTask('less-compile', ['less:compileCore', 'less:compileTheme', 'less:compileCustomize']);
  grunt.registerTask('dist-css', ['less-compile', 'autoprefixer:core', 'autoprefixer:theme', 'autoprefixer:app', 'csscomb:dist', 'cssmin:minifyCore', 'cssmin:minifyTheme', 'cssmin:minifyCustomize']);
  ...
  // Docs task.
  //grunt.registerTask('docs-js', ['uglify:docsJs', 'uglify:app']);
  //grunt.registerTask('lint-docs-js', ['jshint:assets', 'jscs:assets']);
  //grunt.registerTask('docs', ['docs-css', 'lint-docs-css', 'docs-js', 'lint-docs-js',  'copy:docs', 'build-glyphicons-data', 'build-customizer']);
